...
public class Matricies {
	...
	public static void main(String[] args) {
		...
		int[][] inOrderBalloons = {{1,2},{2,3},{3,4},{4,5}};
		int[][] allDifferentBalloons = {{1,2},{3,4},{5,6},{7,8}};
		int[][] outOfOrderBalloons = {{10,16},{2,8},{1,6},{7,12}};
		matricies.minimumArrowsBurstBalloon(inOrderBalloons);
		matricies.minimumArrowsBurstBalloon(allDifferentBalloons);
		matricies.minimumArrowsBurstBalloon(outOfOrderBalloons);
	 ...
	 * */
	public void minimumArrowsBurstBalloon(int[][] minArr) {
		Arrays.sort(minArr, Comparator.comparingInt(o -> o[0]));
		int count = minimumArrowsBurstBalloonHelper(minArr, minArr[0][1], 1);
		System.out.println("COUNT = "+count);
	}
	public int minimumArrowsBurstBalloonHelper(int[][] minArr, int last, int count) {
