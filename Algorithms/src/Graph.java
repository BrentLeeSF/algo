...
public class Graph {
	...
	/**
	 * Prints Graph from a given start point BFS - Start closest to root. Uses a
	 * Queue (FIFO). This is slower and requires more memory. This algorithm works
	 * in single stage. The visited verticies are removed from the queue, then
	 * displayed
	 */
	public void BFS(int start) {
		...
		while (queue.size() != 0) {
			...
			/**
			 * Dequeue a vertex from queue and print it poll() Retrieves and removes the
			...
			/**
			 * Get all adjacent verticies of the dequeued vertex if adjacent vertex has not
	...
	/**
	 * Topological Sort Recursively calls topologicalSortUtil()
	 */
